...
import com.nvidia.spark.rapids.{MetaUtils, RapidsBufferId, ShuffleMetadata}
...
class RapidsMetaResponse(bb: ByteBuffer)
...
class RapidsShuffleMetaBlock(
  ...
  val res = ShuffleMetadata.buildMetaResponse(tableMetas, 1024L * 1024L)
...
class RapidsShuffleBlock(bufferId: RapidsBufferId,
